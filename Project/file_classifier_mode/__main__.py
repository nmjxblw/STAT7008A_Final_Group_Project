...
from .pdf_analysis import pdf_analysis
from .pdf_split_and_embed import pdf_split_and_embed
...
def start_file_classify_task():
    ...
    # 将提取的文本嵌入向量
    success_filename_list = pdf_split_and_embed(
        analysed_data, save_embed_folder, save_data_folder
    )
